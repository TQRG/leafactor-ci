...
import tqrg.leafactor.ci.rules.Cases.VariableDeclared;
import tqrg.leafactor.ci.rules.ViewHolderCases.ConvertViewReassignInflator;
import tqrg.leafactor.ci.rules.ViewHolderCases.ConvertViewReuseWithTernary;
import tqrg.leafactor.ci.rules.ViewHolderCases.VariableAssignedFindViewById;
import tqrg.leafactor.ci.rules.ViewHolderCases.VariableAssignedGetTag;
import tqrg.leafactor.ci.rules.ViewHolderCases.VariableAssignedInflator;
import tqrg.leafactor.ci.rules.ViewHolderCases.VariableCheckNull;
...
//                    boolean isStatic = classOrInterfaceDeclaration.isStatic();
    ...
    private void refactor(CtMethod method) {
        ...
        Iterable.iterateMethod(this, logger, method, false);
    }
