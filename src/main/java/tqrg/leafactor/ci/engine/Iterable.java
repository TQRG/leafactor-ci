package tqrg.leafactor.ci.engine;

import tqrg.leafactor.ci.engine.logging.IterationLogger;
import tqrg.leafactor.ci.engine.logging.SimpleIterationPhaseLogEntry;
...
public interface Iterable {
    ...
    static void iterateBlock(
        ...
        SimpleIterationPhaseLogEntry refactoringPhaseLogEntry = new SimpleIterationPhaseLogEntry(rule, "Refactoring Cases of Interest", "Logs the processing phase of an iteration");
...
//              Todo: do something with the innerContext
        ...
        for (CaseOfInterest caseOfInterest : copyCasesFiltered) {
            ...
            rule.refactorCase(refactoringPhaseContext);
